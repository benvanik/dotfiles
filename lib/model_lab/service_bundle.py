"""Content-bound model runtimes and generated service manifests."""
...
BUNDLE_PLAN_SCHEMA = "model-lab.service-bundle-plan.v1"
IMPLEMENTATION_BUNDLE_SCHEMA = "model-lab.service-implementation-bundle.v1"
IMPLEMENTATION_RECEIPT_SCHEMA = "model-lab.service-implementation-receipt.v1"
DEPLOYMENT_MANIFEST_SCHEMA = "model-lab.service-deployment-manifest.v1"
DEPLOYMENT_IDENTITY_SCHEMA = "model-lab.service-deployment-identity.v1"
...
IMPLEMENTATION_MEMBERS = (
    ImplementationMember(
        "model-lab/service_runtime/run-service",
        "bin/model-lab-service-runtime",
        "0755",
    ),
    ImplementationMember(
        "model-lab/service_runtime/__init__.py",
        "service_runtime/__init__.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/collaborators.py",
        "service_runtime/collaborators.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/compile_cache_archive.py",
        "service_runtime/compile_cache_archive.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/compile_cache_document.py",
        "service_runtime/compile_cache_document.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/compile_cache_files.py",
        "service_runtime/compile_cache_files.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/compile_cache_stage.py",
        "service_runtime/compile_cache_stage.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/controller.py",
        "service_runtime/controller.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/document.py",
        "service_runtime/document.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/execution_environment.py",
        "service_runtime/execution_environment.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/layout.py",
        "service_runtime/layout.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/platform.py",
        "service_runtime/platform.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/snapshot_stage.py",
        "service_runtime/snapshot_stage.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/snapshot_stager.py",
        "service_runtime/snapshot_stager.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/state.py",
        "service_runtime/state.py",
        "0644",
    ),
    ImplementationMember(
        "model-lab/service_runtime/vllm.py",
    ...
    ImplementationMember(
        "lib/model_lab/service_huggingface_policy.py",
        "model_lab/service_huggingface_policy.py",
        "0644",
    ),
    ImplementationMember(
        "lib/model_lab/service_compile_cache.py",
        "model_lab/service_compile_cache.py",
        "0644",
    ),
)
