"""Install one exact model service over a generic host SSH endpoint."""
...
PUSH_PLAN_SCHEMA = "model-lab.service-push-plan.v1"
PUSH_RESULT_SCHEMA = "model-lab.service-push.v1"
