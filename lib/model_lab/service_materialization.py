"""Content-addressed local materialization for model services."""
...
MATERIALIZATION_PLAN_SCHEMA = "model-lab.service-materialization-plan.v1"
MATERIALIZATION_RESULT_SCHEMA = "model-lab.service-materialization.v1"
...
def _validate_file_roles(files: list[dict[str, Any]]) -> None:
    implementation_parent = (
        REMOTE_SESSION_ROOT / "control" / "model-service-runtime"
    )
