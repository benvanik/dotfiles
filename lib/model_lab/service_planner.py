"""Validate and plan one config-only model-service deployment."""
...
VALIDATION_SCHEMA = "model-lab.service-validation.v1"
DEPLOYMENT_PLAN_SCHEMA = "model-lab.service-deployment-plan.v1"
PLANNING_SOURCE_SCHEMA = "model-lab.service-planning-source.v1"
PLANNING_SOURCE_ID = "model-lab-service-planner-v1"
