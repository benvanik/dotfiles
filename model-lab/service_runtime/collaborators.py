"""Typed model-service prerequisites consumed by the lifecycle controller."""
...
from model_lab.service_compile_cache import build_compile_cache_contract
...
def _fail(message: str) -> None:
    raise ModelLabError(message, code="compile_cache_stage_unavailable")
