"""Strict model-lab documents for the vLLM compiled-cache lifecycle."""
...
COMPILE_CACHE_BUNDLE_MANIFEST_SCHEMA = "model-lab.vllm-compile-cache-bundle-manifest.v1"
COMPILE_CACHE_PREPARATION_SCHEMA = "model-lab.vllm-compile-cache-preparation.v1"
COMPILE_CACHE_AUTHOR_CANDIDATE_SCHEMA = "model-lab.vllm-compile-cache-author-candidate.v1"
COMPILE_CACHE_ACCEPTANCE_SCHEMA = "model-lab.vllm-compile-cache-acceptance.v1"
COMPILE_CACHE_STAGE_SOURCE_SCHEMA = "model-lab.vllm-compile-cache-stage-source.v1"
COMPILE_CACHE_STAGE_SCHEMA = "model-lab.local-vllm-compile-cache-stage.v1"
COMPILE_CACHE_PREREQUISITE_SUMMARY_SCHEMA = "model-lab.vllm-compile-cache-prerequisite.v1"
COMPILE_CACHE_LAUNCH_MEASUREMENT_SCHEMA = (
    "model-lab.vllm-compile-cache-launch-measurement.v1"
)
COMPILE_CACHE_STARTUP_PROOF_SCHEMA = "model-lab.vllm-compile-cache-startup-proof.v1"
VLLM_CACHE_EVIDENCE_SCHEMA = "model-lab.vllm-openai-cache-evidence.v1"
...
def validate_contract(contract: Any) -> dict[str, Any]:
    ...
    except (KeyError, ModelLabError) as error:
        raise ModelLabError(
