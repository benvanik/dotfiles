"""Linux, NVIDIA, process, and loopback model-runtime boundaries."""
...
RUNTIME_INSTANCE_SCHEMA = "model-lab.runtime-instance.v1"
    ...
    def verify_runtime(
        ...
        *,
        ...
        if (
            ...
            or report["schema_version"] != "model-lab.upstream-runtime-verification.v1"
