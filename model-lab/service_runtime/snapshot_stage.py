"""Fast verifier for a content-checked Hugging Face snapshot stage."""
...
SNAPSHOT_STAGE_SCHEMA = "model-lab.local-huggingface-stage.v1"
...
def _fail(message: str) -> None:
    raise ModelLabError(message, code="invalid_huggingface_snapshot_stage")
