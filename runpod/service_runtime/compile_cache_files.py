"""Safe filesystem representation for exact vLLM compiled-cache trees."""
...
COMPILE_CACHE_INVENTORY_SCHEMA = "runpod.vllm-compile-cache-inventory.v1"
COMPILE_CACHE_HEADROOM_SCHEMA = "runpod.vllm-compile-cache-headroom.v1"
...
def fail(message: str) -> None:
    raise RunpodLocalError(message, code="compile_cache_operation_failed")
