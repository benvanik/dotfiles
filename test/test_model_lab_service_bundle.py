...
from model_lab.runtime_catalog import load_runtime  # noqa: E402
from model_lab.service_bundle import (  # noqa: E402
    BUNDLE_PLAN_SCHEMA,
...
from model_lab.service_huggingface import (  # noqa: E402
    HuggingFaceClosure,
    HuggingFaceClosureFile,
)

from service_runtime.document import parse_deployment_manifest  # noqa: E402
from model_lab_service_test_fixture import SERVICE_FIXTURE  # noqa: E402
...
class ServiceBundlePlanTest(unittest.TestCase):
    ...
    def test_two_services_share_only_the_generic_implementation(self):
        first_definition = load_service(FIXTURE)
    ...
    def test_private_group_write_is_accepted_but_world_write_is_not(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            member.chmod(0o664)
            with mock.patch(
                "model_lab.service_bundle.IMPLEMENTATION_MEMBERS",
                allowlist,
            ):
                bundle = build_implementation_bundle(source_root=root)
            ...
            with (
                ...
                self.assertRaises(ModelLabError) as hardlinked,
            ):
                build_implementation_bundle(source_root=root)
            self.assertEqual(
