"""Authored model-service definition tests."""
...
class ServiceDefinitionTest(unittest.TestCase):
    def test_valid_definition_normalizes_authored_contract(self):
        ...
        definition = parse_service_toml(payload)
    ...
    def test_semantically_equal_source_has_one_plan_identity(self):
        ...
        first = parse_service_toml(payload)
        second = parse_service_toml(reformatted)
    ...
    def test_checkpoint_selector_is_optional_authored_input(self):
        definition = parse_service_toml(service_toml(checkpoint_line=""))
    ...
    def test_file_loader_retains_bytes_from_one_safe_source(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaises(ModelLabError) as caught:
                load_service(symlink)
            self.assertEqual(
                caught.exception.code,
                "unsafe_authored_document",
            )
