...
class Backend:
    ...
    def prepare(self, service, claim, *, deployment_id):
    ...
    def load(self, service, claim, deployment):
    ...
    def push_huggingface_credential(self, prepared):
        self.events.append("credential-push")
        self.credential_present = True

    def clear_huggingface_credential(self, prepared):
        self.events.append("credential-clear")
        if self.clear_error is not None:
            raise self.clear_error
        self.credential_present = False

    def execute(self, prepared, action, *, cache_mode=None):
    ...
    def close_transport(self, prepared, transport):
...
class Publisher:
    ...
    def publish(self, service, transport, *, ttl_seconds):
