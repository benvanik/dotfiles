...
# ============================================================================
# This config is loaded when running in GNOME Terminal.
# Customize icons, colors, and styles to work better with GNOME Terminal.
#
# To customize:
# 1. Edit this file directly, or run: p10k-configure
# 2. Reload zsh: source ~/.zshrc
# 3. The changes will only apply in GNOME Terminal
# ============================================================================
#
