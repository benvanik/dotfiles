# ============================================================================
# GNOME CONSOLE (KGX) CONFIGURATION
# ============================================================================
# This config is loaded when running in GNOME Console (kgx).
# GNOME Console is the newer terminal app that's replacing GNOME Terminal.
#
# To customize:
# 1. Edit this file directly, or run: p10k-configure
# 2. Reload zsh: source ~/.zshrc
# 3. The changes will only apply in GNOME Console
# ============================================================================
#
# Generated by Powerlevel10k configuration wizard on 2025-10-24 at 13:57 PDT.
...
() {
  ...
  # Hide tool venvs (~/tools/*), only show project venvs.
  typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='${${VIRTUAL_ENV:#$HOME/tools/*}:+${VIRTUAL_ENV:t}}'
  # Custom icon.
