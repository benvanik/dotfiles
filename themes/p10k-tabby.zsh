...
# ============================================================================
# This config is loaded when running in Tabby terminal.
# Keep your preferred settings that look good in Tabby here.
#
# To customize:
# 1. Edit this file directly, or run: p10k configure
# 2. Reload zsh: source ~/.zshrc
# 3. The changes will only apply in Tabby terminal
# ============================================================================
#
